...
<!-- ABOUT THE PROJECT -->
## About The Project
This is a single page application that consumes the gotiny.cc API, and uses it to shorten URLs provided by the user. It sends the long URL via a 
post request and displays the response to the user<br>
The significance of this project is:
<ol>
<li>Polish my ux/ui skills by designing an appealing landing page</li>
<li> Polish dom manipulation skills
</li>
